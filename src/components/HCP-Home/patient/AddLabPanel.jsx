...
/* ── AddLabPanel ─────────────────────────────────── */
const AddLabPanel = ({ patient, chart, onClose, onSave, initialData }) => {
  ...
  const [labResults,   setLabResults]   = useState(initialData?.labResults   || '');
    ...
    <div className="fixed inset-0 z-50" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between" style={{ height: '24px' }}>
          ...
          >
            {isEdit ? 'View Lab & Diagnostic' : 'Add New Labs & Diagnostics'}
          </span>
